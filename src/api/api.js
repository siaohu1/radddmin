...
export const projectDetail = params => {
    return instance.post('/rate/admin/projectDetail', params)
}
//评级项目增加章节
...
export const offProject = id => {
    return instance.post('/rate/admin/offLineProject', id)
}
//投票列表
export const voteList = params => {
    return instance.post('/rate/admin/voteList', params)
}
//新增投票
export const newAddVote = params => {
    return instance.post('/rate/admin/rateVoteAdd', params)
}
//下架投票
export const offVote = params => {
    return instance.post('rate/admin/offLineVote', params)
}
//login
...
export const voteDetail = params => {
    return instance.post('vote/admin/voteDetail',params)
}
//投票修改
export const voteModify = params => {
    return instance.post('rate/admin/rateVoteModify',params)
}
//获取章节列表
export const getChapterList = params => {
    return instance.post('rate/admin/chapterList',params)
}
//编辑章节
export const ediChap = params => {
    return instance.post('/rate/admin/addChapterForProject',params)
}
//删除章节
export const delChapter = params => {
    return instance.post('/rate/admin/deleteChapter',params)
}
