...
" @click='goBack'></i><span style="font-size: 20px;margin-left: 33%">新增项目</span></div>
        <el-row class="rewBox" style="">
            <el-col :span="24"  v-show="infoCoinShow" >
                <el-form name="form"  class="formBox demo-ruleForm" :model="ruleForm" :rules="rules" ref="ruleForm">
                    <!-- <p>币状态：未补全</p> -->
                    <el-form-item label="项目名称" prop="name">
                        <el-col :span="7">
                            <el-input v-model="ruleForm.name" :placeholder= symbol></el-input>
                        </el-col>
                    </el-form-item>
                    <el-upload
                        action="123"
                    ...
                    <el-form-item label="ICO评级" prop="grade">
                        <el-col :span="6">
                            <el-input v-model="ruleForm.grade"></el-input>
                        </el-col>
                    </el-form-item>
                    <el-form-item label="ICO成本" prop="cost">
                        <el-col :span="6">
                            <el-input v-model="ruleForm.cost"></el-input>
                        </el-col>
                    </el-form-item>
                    <el-form-item label="ICO时间" prop="time">
                        <el-col :span="6">
                            <el-date-picker
                                v-model="datatime"
                                type="datetime"
                    ...
                    <el-form-item label="所属行业" prop="secondId">
                        <el-cascader
                            placeholder="试试搜索"
                            :options="options"
                            filterable
                    ...
                    <el-form-item label="官网链接" prop="url">
                        <el-col :span="10">
                            <el-input placeholder="请输入链接" v-model="ruleForm.url">
                            </el-input>
                        </el-col>
                    </el-form-item>
                    <el-form-item label="白皮书" prop="bookUrl">
                        <el-col :span="10">
                            <el-input placeholder="请输入链接" v-model="ruleForm.bookUrl">
                            </el-input>
                        </el-col>
                    </el-form-item>
                    ...
                    <hr>
                    <el-form-item style="padding-left: 40%;padding-top: 1%">
                        <!--<el-button  @click="saveDraft()">保存草稿</el-button>-->
                        <el-button @click="submitForm('ruleForm')">保存发布</el-button>
                    </el-form-item>
                </el-form>
            </el-col>
        </el-row>
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    grade:[
                        {
                            required:true,message:'请输入评级',trigger:'blur'},
                    ],
                    cost:[
                        {
                            required:false,message:'请输入ico成本',trigger:'blur'},
                    ],
                    time:[
                        {
                            required:false,message:'请选择评级时间',trigger:'blur'},
                    ],
                    secondId:[
                        {
                            required:true,message:'请选择二级行业',trigger:'blur'},
                    ],
                    tag:[
                        {
                    ...
                    desc:[
                        {
                            required:false,message:'请填写项目介绍',trigger:'blur'},
                    ],
                    url:[
                        {
                            required:false,message:'请填写官网地址',trigger:'blur'},
                    ],
                    bookUrl:[
                        {
                            required:false ,message:'请填写白皮书地址',trigger:'blur'},
                    ],
                    img:[
                        {
                            required:true,message:'请上传项目图标',trigger:'blur'},
                    ],
                    textLink:[
                        {
                            required:false,message:'请添加文字链接',trigger:'blur'},
                    ],
                    textLink:[
                        {
                            required:false,message:'请添加文字链接',trigger:'blur'},
                    ...
                    iconLink:[
                        {
                            required:false,message:'请添加图标',trigger:'blur'},
                    ],
        ...
        methods: {
            ...
            jumpTagPage(){//跳转标签页面保存
                ...
                api.saveDraft({
                    ...
                    if (data.ret == 1) {
                        alert('保存草稿成功');
                        this.$router.push({path:'industryList'});
                    }
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                            ...
                            api.addProject({
                                ...
                                status:1,
                                //2白皮书地址
                                whiteBook:this.ruleForm.bookUrl,
                                //3项目描述
                                ...
                                textLink:textlinks,
                                //6ico成本
                                icoCost:this.ruleForm.cost,
                                //7ico时间
                                icoTime:timedata,
                                //8币上传logo图片
                                coinLogo:this.imageUrl ,
                                //9二级ID
                                classId:this.ruleForm.secondId,
                                //10项目名
                                projectName:this.ruleForm.name,
                                //11标签
                                tagIds:tagidlist,
                                //12白皮书地址
                                officialWebsite:this.ruleForm.url,
                                //13grade
